...
echo [1/7] Configurando ambiente de build (DEBUG)...
set VCVARS="C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Auxiliary\Build\vcvarsall.bat"
call %VCVARS% x64 >nul
:: DEBUG: sem NDEBUG — logs ativos. MT (release CRT) para tamanho proximo ao release.
set DIAGFLAGS=
python tools\gen_xor_strings_dynamic.py random Loader\xor_strings.h
python tools\encrypt_aobs.py
if not exist build_dbg_ver.txt echo 1214 > build_dbg_ver.txt
set /p BUILD_VER=<build_dbg_ver.txt
set /a BUILD_VER+=1
echo !BUILD_VER!> build_dbg_ver.txt
set OUT_NAME=LOADER_DBG!BUILD_VER!.exe
echo [BUILD DEBUG] Versao: !BUILD_VER! saida: !OUT_NAME!
...
echo [5/7] Compilando Loader (DEBUG)...
cl /nologo /W3 /Ob1 /MT /EHsc /std:c++17 /D "_UNICODE" /D "UNICODE" ^
  ...
  Loader\cave_finder.c Loader\lazyhook.c Loader\gamespeed.c Loader\damage.c Loader\guardian.c Loader\instant_size.c Loader\byovd_lock.c Loader\health_regen.c Loader\immune_boss.c Loader\instakill.c Loader\rapid_fire.c Loader\fly.c Loader\lists.c Loader\havok.c Loader\esp.c Loader\aimbot.c Loader\skeleton.c Loader\tigerlist.c Loader\sobject_list.c ^
  Loader\suicide.c Loader\namechanger.c Loader\debug_buffer.c Loader\revive.c Loader\noturnback.c Loader\nojoinallies.c Loader\noinactivity.c Loader\instant_abilities.c Loader\esp_overlay.cpp Loader\antire.c Loader\antire_handles.c Loader\themida_stubs.c Loader\controller_input.c ^
  Loader\interact_aura.c Loader\aura.c Loader\infinite_ammo.c Loader\ammo.c Loader\no_recoil.c Loader\ammo_brick.c Loader\handling_speed.c Loader\local_player.c Loader\bunnyhop.c Loader\player_cloner.c Loader\movespeed.c Loader\teleports.c Loader\silent_aim.c Loader\matchmaking.c Loader\aob_patterns.c Loader\activity_loader.c Loader\seraph_handle_bucket.c Loader\seraph_ptr_crypt.c Loader\seraph_menu_trigger.c Loader\seraph_ban_marker.c Loader\seraph_secure_val.c Loader\thirdperson.c Loader\spinbot.c > build_loader.log 2>&1
if !ERRORLEVEL! neq 0 (
...
dir loader_build > build_files.log 2>&1
...
link /nologo /OUT:!OUT_NAME! /SUBSYSTEM:WINDOWS /ENTRY:wWinMainCRTStartup ^
     ...
     /LIBPATH:"Loader" > build_link.log 2>&1
if !ERRORLEVEL! neq 0 (
...
echo Build DEBUG concluido com sucesso. !OUT_NAME!
